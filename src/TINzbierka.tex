...
\begin{document}
	...
	\section{Petriho siete}
		...
		\begin{enumerate}
			\item Zostrojte P/T Petriho, ktorá ma 2 miesta, počiatočné značenie $M_0 = (1,0)$ a má nekonečnú množinu $(M_1,M_2, \cdots)$ značení dosiahnuteľných z~$M_0$, pre ktorú platí, že $\forall i > 0, M_i = (m_i,n_i)$, kde $m_i = 1$ a $n_i$ je párne (sudé). Uveďte grafickú reprezentáciu tejto siete a popíšte ju v~zhode s~matematickou definíciou P/T Petriho sietí.
		\end{enumerate}	
